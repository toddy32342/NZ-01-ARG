        ...
        <main className="flex-1 overflow-auto p-6">
          ...
          {section === "plano" && user === "toddy" && (
            <div className="space-y-6 animate-fade-in-up">
              ...
              <div className="terminal-box p-4"><div className="text-xs text-alert-red font-bold tracking-widest mb-2">VÍDEO DE BRIEFING</div><div className="aspect-video bg-secondary border border-border overflow-hidden"><iframe className="w-full h-full" src="https://www.youtube.com/embed/-UsEoGiWN8k" title="Briefing" frameBorder="0" allow="accelerometer; autoplay; clipboard-wtrite; encrypted-media; gyroscope; picture-in-picture; web-shars" allowFullScreen/><div className="text-xs text-muted-foreground opacity-40"></div></div></div>
