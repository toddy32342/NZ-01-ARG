        ...
        <main className="flex-1 overflow-auto p-6">
          {section === "home" && (
            <div className="space-y-6 animate-fade-in-up">
              ...
              <div className="terminal-box p-4"><div className="text-xs text-muted-foreground tracking-widest uppercase mb-2">IMAGEM DO LABORATÓRIO</div><div className="aspect-[21/9] bg-secondary border border-border flex items-center justify-center"><div className="text-xs text-muted-foreground opacity-40"><img src="../assets/Lab.png"/>Foto retirada no inicio das pesquisas.</div></div></div>
